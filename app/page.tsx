...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold tracking-tight text-slate-900 leading-none">CPE</span>
      ...
      {/* Hero Banner (Text Only style like example "Qualifications and tests") */}
      ...
      <div className="bg-slate-50 py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg text-slate-700 max-w-4xl mx-auto">
            At CPE Simulator, we offer the world's most trusted range of English practice simulations, supporting every learner at every stage of their journey. All our tools reflect real-life exam scenarios and meet a wide variety of learning goals.
          </p>
        </div>
      </div>
      ...
      <footer className="bg-slate-900 text-slate-300 py-12">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-slate-800 text-sm text-center">
            &copy; {new Date().getFullYear()} CPE Simulator. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
